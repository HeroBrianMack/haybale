...
import com.t2pellet.haybalelib.network.FabricPacketHandler;
...
public class FabricCommonRegistry implements ICommonRegistry {
    ...
    public Supplier<SimpleParticleType> register(String modid, ParticleEntryType particleEntryType) {
        ...
        Registry.register(BuiltInRegistries.PARTICLE_TYPE, new ResourceLocation(modid, particleEntryType.getName()), type);
        return () -> type;
    }
